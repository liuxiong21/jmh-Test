...
public class JunitAssertTest {
	...
	public void testAssertEqual() {
		assertEquals("found both object is not equals", new Object(),
				new Object());
	}

	@Test
	public void testAssertThathasItemsContainsString() {
		assertThat("not found item", Arrays.asList("one", "two", "three"),
				hasItems("one", "three"));
	}

	@Test
	public void testAssertThatBothContainsString() {
		org.junit.Assert.assertThat("have one of both is not exists",
